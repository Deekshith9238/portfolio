...
const Hero = () => {
  return (
    <div className="flex flex-wrap pb-4 lg:mb-35">
        {/* Left Section: Text */}
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
                <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-6xl">Deekshith H U</h1>
        ...
        <div className="w-full lg:w-1/2 lg:flex lg:justify-center lg:items-center lg:p-8">
            <div className="flex justify-center lg:justify-end">
                <img className="max-w-full h-auto" src="src/assets/kevinRushProfile.jpg" alt="profile-photo"/>
            </div>
        </div>
    </div>
  )
